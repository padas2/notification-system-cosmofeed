...
// Initing kafka components and diff gaing and different skill sets and other skill sets
// Initing diff components and other different components and other components // adding comment for branch-2
KafkaProducer.Init()
KafkaProducer.Start()
KafkaConsumers.Init()
